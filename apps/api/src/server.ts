...
import { swaggerSpec } from "./swagger"; // swagger 문서 표시를 위한 라이브러리
import { query } from "./lib/db"; // db.ts에서 만든 query 함수 가져오기
import authRouter from "./routes/auth"; // auth.ts에서 만든 authRouter 가져오기
import postRouter from "./routes/posts"; // auth.ts에서 만든 authRouter 가져오기
import commentsRouter from "./routes/comments"; // auth.ts에서 만든 authRouter 가져오기
import usersRouter from "./routes/users"; // users.ts에서 만든 usersRouter 가져오기
